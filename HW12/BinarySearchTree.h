...
protected:
   ...
   bool findMinimumValue( ItemType& minimumValue );

   BinaryNode<ItemType>* findMinimumNode(BinaryNode<ItemType>* treePtr ) const;
                                            ...
                                            ItemType& inorderSuccessor, int& newWordCount)
{
	if ( nodePtr->getLeftChildPtr() == nullptr ) {
		...
		BinaryNode<ItemType>* tempPtr;
		tempPtr = removeLeftmostNode( nodePtr->getLeftChildPtr(), inorderSuccessor, newWordCount );
		nodePtr->setLeftChildPtr( tempPtr );
		return nodePtr;
	}
}
...
template<class ItemType>
bool BinarySearchTree<ItemType>::findMinimumValue(ItemType& minimumValue)
{
...
// add your code here
	...
	nodePtr = findMinimumNode(rootPtr);
	if ( nodePtr== nullptr){
		return false;
	}
	else {
		minimumValue = nodePtr->getItem();
		return true;
	}
}

template<class ItemType>
BinaryNode<ItemType>* BinarySearchTree<ItemType>::findMinimumNode(BinaryNode<ItemType>* nodePtr) const
{
