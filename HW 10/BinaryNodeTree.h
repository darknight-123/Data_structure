...
{
    ItemType max=subTreePtr->getItem(),big1=0,big2=0;
/* if (subTreePtr->getLeftChildPtr() != nullptr && subTreePtr->getRightChildPtr() != nullptr)
    {
     big1 = getMaximumHelper(subTreePtr->getLeftChildPtr());
      big2=getMaximumHelper(subTreePtr->getRightChildPtr());
      if (big1 > big2)
      {
          max = big1;
     }
    ...
    {
       big1 = getMaximumHelper(subTreePtr->getRightChildPtr());
    }
      if (subTreePtr->getLeftChildPtr() != nullptr)
    {
      big2 = getMaximumHelper(subTreePtr->getLeftChildPtr()) ;
    }
      if (big1 > big2)
      {
          max = big1;
   ...
   if (subTreePtr->getItem() > max)
   {
       max= subTreePtr->getItem() ;
   }
#define INT_MIN max;
   //return max;
    // add your code here
...
{
   // cout << "\nk=" << subTreePtr->getItem() << "\n";
    // add your code here
  /*  if (subTreePtr == rootPtr&& subTreePtr->getLeftChildPtr() == nullptr && subTreePtr->getRightChildPtr() == nullptr)
    {
    ...
    else if (subTreePtr->getLeftChildPtr() != nullptr && subTreePtr->getRightChildPtr() != nullptr)
    {
         ...
         {
             return getNumberOfNodesHelper(subTreePtr->getLeftChildPtr()) + 1+1 + getNumberOfNodesHelper(subTreePtr->getRightChildPtr()) + 1;
         }
         else
         {
             return getNumberOfNodesHelper(subTreePtr->getLeftChildPtr()) + 1 + getNumberOfNodesHelper(subTreePtr->getRightChildPtr()) + 1;
         }
     }
   else  if (subTreePtr->getLeftChildPtr() != nullptr)
        {
         ...
         if (subTreePtr == rootPtr)
         {
             return getNumberOfNodesHelper(subTreePtr->getLeftChildPtr()) + 1 + 1 ;
         }
         else
         {
    ...
    else    if (subTreePtr->getRightChildPtr() != nullptr)
        {
         ...
         if (subTreePtr == rootPtr)
         {
             return  getNumberOfNodesHelper(subTreePtr->getRightChildPtr()) + 1+1;
         }
         else
         {
