...
{
    Node<ItemType>* curPtr = headPtr;
    Node<ItemType>* nowPtr = new Node<ItemType>();
    
    nowPtr->setNext(nullptr);
    nowPtr->setItem(newEntry);
    if (headPtr == nullptr)
    {
        headPtr = nowPtr;
    }
...
bool LinkedBag<ItemType>::add2ndToLast(const ItemType& newEntry)
{
   ...
   Node<ItemType> *nowPtr = new Node<ItemType>();
    ...
    else if (curPtr->getNext() == nullptr)
    {
        nowPtr->setNext(headPtr);
        headPtr = nowPtr;
    }
    else
    {
...
bool LinkedBag<ItemType>::remove2ndToLast()
{
   ...
   // add your code here
    if (canRemoveItem == true)
    {
        ...
        else if (headPtr->getNext()->getNext() == nullptr)
        {
            headPtr = headPtr->getNext();
        }
        else
        {
            while (1)
            {
                if (curPtr->getNext()->getNext()->getNext()==nullptr)
                {
