                                            ...
                                            ItemType& inorderPredecessor, int& newWordCount)
{
	...
	else if (nodePtr->getRightChildPtr()->getRightChildPtr() == nullptr)
	{
		inorderPredecessor = nodePtr->getRightChildPtr()->getItem();
		newWordCount = nodePtr->getRightChildPtr()->getCount();
		...
		{
			nodePtr->setRightChildPtr(nodePtr->getRightChildPtr()->getLeftChildPtr());
		}
		return nodePtr;
	}
	else
		return removeLeftmostNode(nodePtr->getLeftChildPtr(), inorderPredecessor, newWordCount);
}
